<div class="my-5 border border-gray-300 bg-white rounded-lg shadow-full w-[98%]">
	...
	<div class="p-4">
		<form id="hnupdate-postmeta" data-postid="{{ $postID }}">
			@php
				$fields = [
					'haun_quality' 		    => __('Quality', 'hnmanager'),
					'haun_rating' 		    => __('IMBD Rating', 'hnmanager'),
					'haun_votes' 		    => __('IMBD Vote', 'hnmanager'),
					'haun_runtime' 		    => __('Runtime', 'hnmanager'),
					'haun_original_title' 	=> __('Original Title', 'hnmanager'),
					'haun_trailer_url' 		=> __('Trailer URL', 'hnmanager'),
					'haun_episode' 		    => __('Episode', 'hnmanager'),
					'haun_total_episode' 	=> __('Total Episode', 'hnmanager'),
				];
			@endphp
			...
			<div class="grid grid-cols-2 gap-4">
				<div class="flex flex-col m-2">
					<label class="mb-2 font-semibold" for="haun_movie_notice">@hnlang('Notification/Note')</label>
					<textarea name="haun_movie_notice" rows="5" class="rounded-none border-slate-200 border border-solid p-2" id="haun_movie_notice" placeholder="@hnlang('Notification/Note')">{{ isset($metaPost['haun_movie_notice']) ? $metaPost['haun_movie_notice'] : '' }}</textarea>
				</div>
				
				<div class="flex flex-col m-2">
					<label class="mb-2 font-semibold" for="haun_showtime_movies">@hnlang('Showtime Movies')</label>
					<textarea name="haun_showtime_movies" rows="5" class="rounded-none border-slate-200 border border-solid p-2" id="haun_showtime_movies" placeholder="@hnlang('Showtime Movies')">{{ isset($metaPost['haun_showtime_movies']) ? $metaPost['haun_showtime_movies'] : '' }}</textarea>
				</div>
			</div>
			...
			<div class="flex flex-wrap my-4">
				<div class="flex items-center w-32 mr-4">
					<span class="font-semibold">@hnlang('Status'):</span>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="ongoing" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Ongoing')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="completed" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Completed')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="is_trailer" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Trailer')</label>
				</div>
			</div>

			<div class="flex flex-wrap my-4">
				<div class="flex items-center w-32 mr-4">
					<span class="font-semibold">@hnlang('Formality'):</span>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="single_movies" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Movies')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="tv_series" class="mr-2 text-sm font-medium text-gray-900">@hnlang('TV Series')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="tv_shows" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Trailer')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="theater_movie" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Theater Movie')</label>
				</div>
			</div>
			
			<div class="flex flex-wrap my-4">
				<div class="flex items-center w-32 mr-4">
					<span class="font-semibold">@hnlang('Options'):</span>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="is_adult" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Adult content (18+)')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="is_copyright" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Copyright')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="is_one_slide" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Add to One Slide (Slider one by one)')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="is_carousel_slide" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Add to Carousel Slider')</label>
				</div>
				<div class="flex items-center me-4">
					...
					<label for="paging_episode" class="mr-2 text-sm font-medium text-gray-900">@hnlang('Paging the episode list')</label>
				</div>
			</div>

			<input type="submit" name="hnsubmit-postmeta" value="@hnlang('Update Post Info')" id="hnsubmit-postmeta" class="mt-3 bg-violet-500 hover:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-300 active:bg-violet-700 px-5 py-2 text-sm leading-5 rounded-full font-semibold text-white">
		</form>
	</div>
</div>