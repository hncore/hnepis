...
window.hncolor = function(varcolor) {
    return player_epis?.hncolor[varcolor] || varcolor;
};
...
window.List_Episodes = function () {
    return {
        ...
        HNSetColor() {
            if (hncolor('btn_bgcolor')) {
                document.documentElement.style.setProperty('--btnbg', hncolor('btn_bgcolor'));
            }
            if (hncolor('btn_textcolor')) {
                document.documentElement.style.setProperty('--btntext', hncolor('btn_textcolor'));
            }
            if (hncolor('btn_hover')) {
                document.documentElement.style.setProperty('--btnhover', hncolor('btn_hover'));
            }
            if (hncolor('btn_radius')) {
                document.documentElement.style.setProperty('--btnradius', hncolor('btn_radius'));
            }
            if (hncolor('backupbg')) {
                document.documentElement.style.setProperty('--backupbg', hncolor('backupbg'));
            }
            if (hncolor('backuptext')) {
                document.documentElement.style.setProperty('--backuptext', hncolor('backuptext'));
            }
            if (hncolor('backuphover')) {
                document.documentElement.style.setProperty('--backuphover', hncolor('backuphover'));
            }
            if (hncolor('backupbgactive')) {
                document.documentElement.style.setProperty('--backupbgactive', hncolor('backupbgactive'));
            }
            if (hncolor('backuptextactive')) {
                document.documentElement.style.setProperty('--backuptextactive', hncolor('backuptextactive'));
            }
            if (hncolor('bordersv')) {
                document.documentElement.style.setProperty('--bordersv', hncolor('bordersv'));
            }

            if (hncolor('episbgcolor')) {
                document.documentElement.style.setProperty('--episbgcolor', hncolor('episbgcolor'));
            }
            if (hncolor('episbghover')) {
                document.documentElement.style.setProperty('--episbghover', hncolor('episbghover'));
            }
            if (hncolor('episbglist')) {
                document.documentElement.style.setProperty('--episbglist', hncolor('episbglist'));
            }
            if (hncolor('epistextsv')) {
                document.documentElement.style.setProperty('--epistextsv', hncolor('epistextsv'));
            }
            if (hncolor('commentsbg')) {
                document.documentElement.style.setProperty('--commentsbg', hncolor('commentsbg'));
            }
        },
        ...
        loadEpisode(event) {
            ...
            .then((response) => {
                ...
                if (hnresponse.status) {
                    ...
                    $("#ajax-player").html(hnresponse.sources);
                    $(".haun-episode").removeClass("active");
...
$(document).on("click", ".hnload-ajax-epis", function (event) {
    const hnEpAjax = window.HNEp_Ajax();
