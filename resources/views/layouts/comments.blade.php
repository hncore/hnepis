@if(defined('ENABLE_COMMENTS') && ENABLE_COMMENTS && csoptionepis('enable_site_comment'))
		...
		<div class="-mx-[5px] p-0 list-none lg:-mx-[5px] mb-2">
			@if(csoptionepis('select_comments') == 'disqus_comment')
				<div class="w-full mx-1.5">
					...
					<script>
						var disqus_shortname = '{{ csoptionepis("disqus_shortname") != '' ? csoptionepis("disqus_shortname") : "haunytb" }}';
						(function() {
			...
			@elseif(csoptionepis('select_comments') == 'custom_comment') 
				{!! apply_filters('hncore_custom_comment', '') !!}
			@endif
		</div>
	</div>
@endif